...
scripts:
  sh: .specify/scripts/bash/check-prerequisites.sh --json --template checklist-template
  ps: .specify/scripts/powershell/check-prerequisites.ps1 -Json -Template checklist-template
  py: .specify/scripts/python/check_prerequisites.py --json --template checklist-template
---
